/* ERP service worker — v1.141 Step 1 live preview */
const CACHE = "erp-shell-v46";
const SHELL = ["./","./index.html","./v141-step1.css","./manifest.webmanifest","./favicon.png","./assets/business-card-gownii.png","./icons/icon-180.png","./icons/icon-192.png","./icons/icon-512.png"];
