/* ERP service worker — v1.145 Dutch Pay typography and headers */
const CACHE = "erp-shell-v53-v145";
const SHELL = ["./","./index.html","./v142-dutch-pay.css?v=1451","./manifest.webmanifest","./favicon.png","./assets/business-card-gownii.png","./icons/icon-180.png","./icons/icon-192.png","./icons/icon-512.png"];
