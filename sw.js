/* ERP service worker — v1.141 Step 3 live preview */
const CACHE = "erp-shell-v48-step3";
const SHELL = ["./","./index.html","./v141-step1.css?v=1413","./manifest.webmanifest","./favicon.png","./assets/business-card-gownii.png","./icons/icon-180.png","./icons/icon-192.png","./icons/icon-512.png"];
