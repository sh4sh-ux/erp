/* ERP service worker — v1.144 clean master lists */
const CACHE = "erp-shell-v52-v144";
const SHELL = ["./","./index.html","./v142-dutch-pay.css?v=1441","./manifest.webmanifest","./favicon.png","./assets/business-card-gownii.png","./icons/icon-180.png","./icons/icon-192.png","./icons/icon-512.png"];
