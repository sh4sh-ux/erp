/* ERP service worker — v1.152 inventory and workspace release */
const CACHE = "erp-shell-v62-v152";
const SHELL = ["./","./index.html","./v142-dutch-pay.css?v=1501","./workspace-system.css?v=1520","./workspace-layout.js?v=1520","./navigation-layout.css?v=1512","./manifest.webmanifest","./favicon.png","./assets/business-card-gownii.png","./icons/icon-180.png","./icons/icon-192.png","./icons/icon-512.png"];
