/* ERP service worker — v1.142 Dutch Pay desktop visual system */
const CACHE = "erp-shell-v49-v142";
const SHELL = ["./","./index.html","./v142-dutch-pay.css?v=1420","./manifest.webmanifest","./favicon.png","./assets/business-card-gownii.png","./icons/icon-180.png","./icons/icon-192.png","./icons/icon-512.png"];
