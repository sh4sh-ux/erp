/* ERP service worker — v1.149 compact controls */
const CACHE = "erp-shell-v57-v149";
const SHELL = ["./","./index.html","./v142-dutch-pay.css?v=1491","./manifest.webmanifest","./favicon.png","./assets/business-card-gownii.png","./icons/icon-180.png","./icons/icon-192.png","./icons/icon-512.png"];
