/* ERP service worker — v1.146 measured Dutch Pay v6.20 values */
const CACHE = "erp-shell-v54-v146";
const SHELL = ["./","./index.html","./v142-dutch-pay.css?v=1461","./manifest.webmanifest","./favicon.png","./assets/business-card-gownii.png","./icons/icon-180.png","./icons/icon-192.png","./icons/icon-512.png"];
