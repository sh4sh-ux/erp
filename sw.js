...
const CACHE = "erp-shell-v95-v182";
const SHELL = ["./","./index.html","./v142-dutch-pay.css?v=1501","./workspace-system.css?v=1810","./workspace-layout.js?v=1810","./navigation-layout.css?v=1512","./mobile-workspace.css?v=1690","./manifest.webmanifest","./favicon.png","./assets/business-card-gownii.png","./icons/icon-180.png","./icons/icon-192.png","./icons/icon-512.png"];
SHELL.push('./stock-entry.js?v=1650','./stock-entry.css?v=1710');
SHELL.push('./quote-presentation.css?v=1820','./quote-presentation.js');
