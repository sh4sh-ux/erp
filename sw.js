/* ERP service worker — v1.148 unified desktop controls */
const CACHE = "erp-shell-v56-v148";
const SHELL = ["./","./index.html","./v142-dutch-pay.css?v=1481","./manifest.webmanifest","./favicon.png","./assets/business-card-gownii.png","./icons/icon-180.png","./icons/icon-192.png","./icons/icon-512.png"];
