...
const CACHE = "erp-shell-v61-v151-headers";
const SHELL = ["./","./index.html","./v142-dutch-pay.css?v=1501","./workspace-system.css?v=1512","./workspace-layout.js?v=1512","./navigation-layout.css?v=1512","./manifest.webmanifest","./favicon.png","./assets/business-card-gownii.png","./icons/icon-180.png","./icons/icon-192.png","./icons/icon-512.png"];
