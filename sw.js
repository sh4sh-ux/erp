/* ERP service worker — v1.147 computed-style parity */
const CACHE = "erp-shell-v55-v147";
const SHELL = ["./","./index.html","./v142-dutch-pay.css?v=1471","./manifest.webmanifest","./favicon.png","./assets/business-card-gownii.png","./icons/icon-180.png","./icons/icon-192.png","./icons/icon-512.png"];
