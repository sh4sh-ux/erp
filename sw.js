...
const CACHE = "erp-shell-v80-v170";
const SHELL = ["./","./index.html","./v142-dutch-pay.css?v=1501","./workspace-system.css?v=1680","./workspace-layout.js?v=1530","./navigation-layout.css?v=1512","./mobile-workspace.css?v=1690","./manifest.webmanifest","./favicon.png","./assets/business-card-gownii.png","./icons/icon-180.png","./icons/icon-192.png","./icons/icon-512.png"];
SHELL.push('./stock-entry.js?v=1650','./stock-entry.css?v=1700');
