...
const CACHE = "erp-shell-v50-v142";
const SHELL = ["./","./index.html","./v142-dutch-pay.css?v=1421","./manifest.webmanifest","./favicon.png","./assets/business-card-gownii.png","./icons/icon-180.png","./icons/icon-192.png","./icons/icon-512.png"];
